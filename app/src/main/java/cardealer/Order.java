...
import cardealer.external.Payment;
...
public class Order {
    ...
    public void onPostPersist(){
        ...
        cardealer.external.Payment payment = new cardealer.external.Payment();
        payment.setOrderId(this.getId());
        payment.setProcess("Ordered");

        // mappings goes here
         AppApplication.applicationContext.getBean(cardealer.external.PaymentService.class)
            .pay(payment);
